...
export function pidFilePath(dir, name = 'worker') {
...
export function readIdentity(dir, name = 'worker') {
    try {
 ...
 */
export function verify(dir, root, name = 'worker') {
 ...
 * 있는 것으로 보인다.
 */
export function acquire(dir, info) {
 ...
 */
export function release(dir, reason) {
 ...
 * 같은 일이 일어난다.
 */
export async function rootTag(root) {
